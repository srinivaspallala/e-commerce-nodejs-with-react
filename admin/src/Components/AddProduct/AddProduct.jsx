    ...
    const add_product = async ()=>{
        ...
        if(responseData.success){
            ...
            await fetch('http://localhost:4000/addproduct',{
                ...
                data.success?alert("Product Added"):alert('Adding Failed')
            })
        }
  ...
  return (
    <div className='add-product'>
      ...
      <div className="addproduct-itemfield">
        ...
        <select name="category" value={productDetails.category} onChange={changeHandler} id="" className='add-product-selector'>
